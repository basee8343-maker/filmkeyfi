...
export default function VoiceControls({ voice }) {
  ...
  return <div className="relative flex items-center gap-2">
    <div className="absolute bottom-12 left-0 whitespace-nowrap rounded-md bg-black/90 px-2 py-1 text-[9px] text-white/80">{connectionLabels[voice.connectionState]}</div>
