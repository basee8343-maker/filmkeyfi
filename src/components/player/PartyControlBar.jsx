...
export default function PartyControlBar({ voice, voiceEnabled, unread, directUnread, settingsOpen, chatOpen, directOpen, onSettings, onChat, onDirect }) {
  ...
  return (
    <div className="absolute inset-x-0 bottom-0 z-50 flex w-full items-center gap-3 border-t border-white/10 bg-black/95 px-4 py-2 backdrop-blur-xl sm:px-6" style={{ paddingBottom: 'calc(0.5rem + env(safe-area-inset-bottom))' }}>
