...
function Person({ person, profile, ownerId, status, onSelect }) {
...
export default function ParticipantHistoryPanel({ participants, recentParticipants, profiles, presenceMap, ownerId, onSelect }) {
