  ...
  return <section className="rounded-2xl border border-border bg-card p-5">
    ...
    <div className="flex flex-col items-center gap-4 sm:flex-row sm:items-start">
      <div className="relative h-56 w-56 shrink-0 select-none" style={{ touchAction: 'none' }}>
        <div ref={windowRef} onPointerDown={onPointerDown} onPointerMove={onPointerMove} onPointerUp={onPointerUp} onPointerCancel={onPointerUp} className="absolute cursor-grab overflow-hidden rounded-full bg-background active:cursor-grabbing" style={{ left: `${left * 100}%`, top: `${top * 100}%`, width: `${diameter * 100}%`, height: `${diameter * 100}%` }}>
