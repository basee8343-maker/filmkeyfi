...
export default function FrameDisplaySettings({ user, onUpdated }) {
  ...
  const save = async (entrance = user.profile_frame_entrance_enabled) => {
    ...
    try {
      ...
      toast({ title: 'Çerçeve görünümü güncellendi' }); onUpdated?.();
