...
export default function ChatPanel({ friendship, messages, userId, invoke }) {
  ...
  return <section className="bg-card border border-border rounded-xl min-h-96 flex flex-col overflow-hidden"><header className="p-4 border-b border-border"><h2 className="font-bold">{name}</h2><p className="text-xs text-muted-foreground">Özel mesaj</p></header>
