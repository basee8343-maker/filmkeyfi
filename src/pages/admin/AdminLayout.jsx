...
import { LayoutDashboard, UserCheck, Users, Film, FolderTree, DoorOpen, MessageSquare, LifeBuoy, CreditCard, RefreshCw, Bell, Settings, LogOut, Menu, X, ShieldAlert, KeyRound, Crown, ChevronDown, Package as PackageIcon, Home, Flag, MessageCircle, Video, Smartphone, Sparkles } from 'lucide-react';
...
const nav = [
  ...
  { to: '/admin/ozel-cerceve', label: 'Özel Çerçeve / XMAN', icon: Sparkles },
